...
-Win & Lose Conditions
 Win Condition: Reaching the end of the linear level and triggering the end-game screen after unlocking all abilities.
...
LEFT SHIFT: Dash
SPACE (on walls): Wall Jump
E: Next Dialogue 

This game was developed entirely as a solo project.
Taha Berk Yıldız
